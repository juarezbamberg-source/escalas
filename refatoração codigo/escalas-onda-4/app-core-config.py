...
class Settings(BaseSettings):
    """Configuracao central da aplicacao (Onda 4).

    As regras de negocio que antes eram constantes fixas no codigo agora
    sao configuraveis via variaveis de ambiente / .env, com valores padrao
