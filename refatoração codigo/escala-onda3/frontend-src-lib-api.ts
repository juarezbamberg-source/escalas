...
export const api = {
  ...
  listAlocacoes: (turno: string) => request<Alocacao[]>(`/alocacoes?turno=${encodeURIComponent(turno)}`),
  ...
  /**
   * Endpoint dedicado de carga por professor (Onda 3).
   * Substitui a agregacao feita no cliente pelo DashboardPage.
   */
